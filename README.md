...
```
git clone -b Termux-Support-Branch https://github.com/oscar-03/HiddenEye2
...
##INSTALL EN KALI LINUX

git clone https://github.com/oscar-03/HiddenEye2
...
python3 HiddenEye.Py  |  sudo su python3 HiddenEye.py
